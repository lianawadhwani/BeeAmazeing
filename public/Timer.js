class Timer {
  constructor(id, startingMins, startingSeconds, delay=100) { //Delay in ms starting time in seconds
    this.state = "paused";
    this.delay = delay;
...
stopwatch = new Timer("stopwatch",0,3);
console.log(stopwatch.startValue);
